    ...
    <section id="contact">
      <div className="section-inner contact-layout">
        ...
        <div className="contact-links">
          ...
          <a className="contact-link" href="https://modrinth.com/user/Impopite" target="_blank" rel="noopener noreferrer" key="Modrinth">
            <div className="contact-icon">
              <ModrinthIcon />
            </div>
            <div className="contact-info">
              <span className="contact-platform">Modrinth</span>
              <span className="contact-handle">Impopite</span>
            </div>
            <span className="contact-arrow" aria-hidden="true">→</span>
          </a>
